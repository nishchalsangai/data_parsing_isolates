class UiString {
  ...
  static const charSet = '0123456789ABCDEFGHIJKLMNOPQRSTUVXYZabcdefghijklmnopqrstuvwxyz-._';

  static const kycApplied = "Successfully applied Kyc";
  static const wrongOtp = "Wrong Otp";

  static final internationalNumber =
  ...
  static const passwordNotSame = "Password you entered is not same";
  static const confirmText = 'Confirm';
  static const documentVerifyText = 'We need to verify your ID';
  static const documentVerifyActionDescription = 'Select the type of document you wish to attach';
  ...
  static const userExistsOnMail = 'User already exists.\nPlease sign in using Email !';
  static const authenticationError = 'Could not authenticate the user.\nPlease contact support !';
  ...
  static const dummyProfileImage =
      'https://wedsinnode.s3.ap-south-1.amazonaws.com/Extra/image+(9).png';

  static const occupationWithNullWorksat = ['homemaker', 'unemployed', 'prefer not to say'];

  static const matched = 'Matched!';
  static const itsMatched = "It's a Match!";
  static const mutualLike = "Super Matched!";

  static const receiverId = 'receiverId';
  static const chatBasketId = 'chatBasketId';
